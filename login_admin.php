...
<html lang="en">
  <head>
    ...
    <style type="text/css">
    .coverBg {
      background-image: url(images/background/bedengan.jpg);
...
<div class="coverBg">
  ...
  <?php
      ...
      if (isset($_POST['login_1'])) {
          ...
          $sql = "SELECT * FROM admin WHERE iduser='$iduser' AND password='$password'";
    ...
    <div class="row">
    		<div class="col">
    			<div class="container3">
    				<form name="masuk" method="POST" onsubmit="return validateForm()">
						<p style="font-family: 'Croissant One', cursive; font-size: 35px; padding-top: 30px;"><b>LOGIN ADMIN</b></p>
							<div class="tulis">
								<p>User ID</p>
            ...
            type="submit" name="login_1">SUBMIT</button>
            <p style="font-family: 'Nunito', sans-serif; padding-top: 10px;"> Bukan Admin ? <a href="login.php" style="color: white; font-family: 'Nunito', sans-serif;"> Klik disini ! </a></p>
					</form>
    			</div>
    		</div>
